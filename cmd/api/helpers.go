...
// readJSON reads JSON from request body into data. Only accepts a single JSON value in the body
func (app *application) readJSON(w http.ResponseWriter, r *http.Request, data interface{}) error {
	maxBytes := 1048576 // One megabyte max in request body
	...
	// Strictly allowing just one entry in the json file
...
// badRequest sets a JSON with error and message in case there's a bad request
...
// InvalidCredentials checks for valid credentials
