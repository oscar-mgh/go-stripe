...
// General function that may handle different types of payments like Stripe, Paypal etc.
...
// cardErrorMessage return human readable versions of card error messages
