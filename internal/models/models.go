...
// InsertTransaction inserts a new txn, and returns is id
func (m *DBModel) InsertTransaction(txn Transaction) (int, error) {
	...
	stmt := `
		insert into transactions
			...
			payment_intent, payment_method, expiry_month, expiry_year, 
...
// InsertOrder inserts a new order, and returns is id
...
// InsertCustomer inserts a new order, and returns is id
...
// GetAllOrdersPaginated returns a slice of a of a subset of orders
